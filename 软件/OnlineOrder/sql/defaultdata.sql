...
#########      用户数据			  #################
###################################################
INSERT INTO `onlineorder`.`t_user`(`user_id`, `username`, `password`, `rank`, `age`, `birth`, `use`)
  VALUES ('00000000000000000001', '张三', '111111', 5, 20, '1998-02-04', 1),
  ('00000000000000000002', '李四', '444444', 5, 20, '1998-02-04', 1),
  ('00000000000000000003', '王五', '555555', 5, 20, '1998-02-04', 1),
  ('00000000000000000004', '赵六', '666666', 5, 20, '1998-02-04', 1),
  ('00000000000000000005', '孙七', '777777', 5, 20, '1998-02-04', 1),
  ('00000000000000000006', '周八', '888888', 5, 20, '1998-02-04', 1),
  ('00000000000000000007', '吴九', '999999', 5, 20, '1998-02-04', 1),
  ('00000000000000000008', '郑十', '101010', 5, 20, '1998-02-04', 1);
